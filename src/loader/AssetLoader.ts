...
export class AssetLoader {
    ...
    static async loadData(){
        ...
        for (const path in modules) {
            ...
            if (fileName.endsWith(".json")) {
                ...
                globalAsset[fileName] = texture[fileName] || texture; 
            }
        }
    ...
    async loadAll() {
        ...
        for (const path in modules) {
            ...
            else if(fileName.includes("sprite")){

                console.log("spritesheet file name : ", fileName);

                // is case me sprite sheet ki png maintained ho bs 
